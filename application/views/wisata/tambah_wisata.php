            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Silahkan Masukkan Data Wisata</p>
                </div>
                <div class="card-body">
                  <form role="form"  method="POST" enctype="multipart/form-data" action="<?= base_url('index.php/admin/tambah')?>">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Alamat" aria-label="Email" aria-describedby="email-addon" name="nama" value="<?= set_value('nama') ?>">
                      <?= form_error('nama', '<small class="text-gradient text-primary pl-3">', '</small>'); ?>
                    </div>
                    <label>Alamat</label>
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Alamat" aria-label="Email" aria-describedby="email-addon" name="alamat" value="<?= set_value('alamat') ?>">
                      <?= form_error('alamat', '<small class="text-gradient text-primary pl-3">', '</small>'); ?>
                    </div>
                    <label>Url Gambar</label>
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Url Gambar" aria-label="Email" aria-describedby="email-addon" name="foto" value="<?= set_value('foto') ?>">
