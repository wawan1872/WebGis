					...
					<div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
						<div class="card card-plain mt-8">
							<div class="card-header pb-0 text-left bg-transparent">
								...
								<p class="mb-0">Silahkan Edit Data Wisata</p>
							</div>
							<div class="card-body">
								<form role="form" method="POST" action="">
									...
									<div class="mb-3">
										<input type="text" class="form-control" placeholder="Nama Jalan"
											aria-label="Email" aria-describedby="email-addon" name="nama"
											value="<?= $tb_wisata ['nama']; ?>">
										<?= form_error('nama', '<small class="text-gradient text-primary pl-3">', '</small>'); ?>
									</div>
									<label>Alamat</label>
									<div class="mb-3">
										<input type="text" class="form-control" placeholder="Alamat"
											aria-label="Email" aria-describedby="email-addon" name="alamat"
											value="<?= $tb_wisata ['alamat']; ?>">
										<?= form_error('alamat', '<small class="text-gradient text-primary pl-3">', '</small>'); ?>
									</div>
									<label>Url Foto</label>
									<div class="mb-3">
										<input type="text" class="form-control" placeholder="Url Gambar"
											aria-label="Email" aria-describedby="email-addon" name="foto"
											value="<?= $tb_wisata ['foto']; ?>">
										<?= form_error('foto', '<small class="text-gradient text-primary pl-3">', '</small>'); ?>
									</div>
                  <label>Kategori</label>
									<div class="mb-3">
										<input type="text" class="form-control" placeholder="Kategori"
											aria-label="Email" aria-describedby="email-addon" name="kategori"
											value="<?= $tb_wisata ['kategori']; ?>">
										<?= form_error('kategori', '<small class="text-gradient text-primary pl-3">', '</small>'); ?>
									</div>
