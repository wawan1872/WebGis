...
<head>
  ...
  <!-- CSS Files -->
  <link href="<?=base_url('assets/')?>assets/css/black-dashboard.css?v=1.0.0" rel="stylesheet" />
...
<body class="">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <div class="photo">
                    <img src="<?=base_url('assets/')?>assets/img/anime3.png" alt="Profile Photo">
                  </div>
  ...
  <script src="<?=base_url('assets/')?>assets/js/black-dashboard.min.js?v=1.0.0"></script><!-- Black Dashboard DEMO methods, don't include it in your project! -->
